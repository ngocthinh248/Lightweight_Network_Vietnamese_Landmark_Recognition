...
# parser.add_argument('--class_folder', default=None,
#                     help="create data folder for each class inside Root folder")  
...
if __name__ == '__main__':
    ...
    def run(image_folder):
        ...
        for img_url in img_urls:
            ...
            extract_placeCNN_feature(model, img_url, os.path.join(raw_output_folder_path, file_name + '.npy'))
            count += 1      
